                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-6">
                            ...
                            <select data-live-search="true" title="@lang('dashboard.products.select_offer')" class="selectpicker form-control @error('offer_id') is-invalid @enderror" id="offer_id" name="offer_id">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select data-live-search="true" title="@lang('dashboard.products.select_brand')" name="brand_id" id="brand" class="selectpicker form-control @error('brand_id') is-invalid @enderror" data-size="4">
                            ...
                            <option {{ $product->brand_id == $brand->id? 'selected':'' }} value="{{ $brand->id }}">{{ $brand->{lang('name')} }}</option>
                            @endforeach
                        </select>
                        @error('brand_id')
                        <span class="invalid-feedback">{{ $message }}</span>
                    ...
                    <div class="form-group">
                        ...
                        <select data-live-search="true" name="status" id="status" class="selectpicker form-control @error('status') is-invalid @enderror">
